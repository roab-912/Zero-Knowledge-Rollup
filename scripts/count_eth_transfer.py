...
-----
  ...
  python scripts/count_eth_transfer.py
  python scripts/count_eth_transfer.py --start 2025-01-01 --end 2025-12-31 --samples 400
  python scripts/count_eth_transfer.py --start 2025-06-01 --end 2025-06-30
