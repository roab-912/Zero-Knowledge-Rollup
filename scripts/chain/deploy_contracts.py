...
Usage :
    python scripts/chain/deploy_contracts.py [--sizes 1,2,4,8,16,32,64]
    python scripts/chain/deploy_contracts.py --reset          # repart d'un .env propre
    python scripts/chain/deploy_contracts.py --skip-existing   # ne redéploie que le manquant
