...
-----
    ...
    python scripts/bench/measure_batch_cost.py --repeats 100 --size 2

    # essai à coût nul (eth_estimateGas, sans broadcast ni fonds) :
    python scripts/bench/measure_batch_cost.py --repeats 5 --size 2 --estimate-only

    # décomposition (verify / storage+overhead) en plus :
    python scripts/bench/measure_batch_cost.py --repeats 100 --size 2 --decompose
"""
