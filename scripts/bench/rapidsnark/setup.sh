...
# scripts/bench/generate_proofs.py fonctionnent telles quelles :
#
...
#
# Usage : bash scripts/bench/rapidsnark/setup.sh [chemin/vers/circuits]
set -euo pipefail
...
Bench :
  python3 scripts/bench/measure_zk_resources.py --skip-setup --sizes 1,2,4,8 \\
