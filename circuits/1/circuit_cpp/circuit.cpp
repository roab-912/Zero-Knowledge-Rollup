...
uint get_total_signal_no() {return 195;}

uint get_number_of_components() {return 19;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 159;}
...
{
std::string new_cmp_name = "verifyTransactions";
VerifyTransaction_8_create(mySignalStart+11,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "allValid";
RecursiveAnd_9_create(mySignalStart+9,0+ctx_index+1,ctx,new_cmp_name,myId);
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 86
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 101
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 1;
{
